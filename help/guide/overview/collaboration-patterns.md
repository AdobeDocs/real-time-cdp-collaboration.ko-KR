...
## 광고주-발행인 {#advertiser-to-publisher}
...
## 광고주-광고 플랫폼 {#advertiser-to-advertising-platform}

광고주와 광고 플랫폼 간 공동 작업 패턴을 통해 광고주는 [!DNL Amazon Marketing Cloud]&#x200B;([!DNL AMC])과 같은 서드파티 광고 플랫폼과 연결하여 마케팅 기능을 향상시킬 수 있습니다. 이 패턴을 통해 광고주는 플랫폼의 ID 확인 및 타겟팅 도구를 활용하여 데이터의 영향을 확장할 수 있습니다. 광고 플랫폼과 통합하면 광고주는 대상 전체에 정확한 성과 통찰력을 제공하여 지출을 최적화하고 관련성을 개선하며 측정 가능한 비즈니스 결과를 도출하도록 할 수 있습니다.
