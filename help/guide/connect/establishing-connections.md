...
![키 일치](/help/assets/connect/establish-connection/match-keys.png){zoomable="yes"}
...
![법적 계약.](/help/assets/connect/establish-connection/legal-agreement.png){zoomable="yes"}
