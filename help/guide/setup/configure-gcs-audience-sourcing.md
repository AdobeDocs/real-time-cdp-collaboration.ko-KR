...
소싱이 시작되기 전에 대상 파일이 **[대상 소싱 사양(v1.3)](../../assets/quick-start/RTCDP_Collaboration_Audience_Sourcing_Spec_v1_3.pdf)**&#x200B;을 준수해야 합니다. 전체 스키마 정의 및 필드 수준 예제에 대한 사양을 검토합니다. 주요 요구 사항은 다음과 같습니다.
...
필수 구성 단계(예: GCS 버킷 설정 및 IAM 역할 할당)를 요약한 사전 요구 사항 대화 상자가 나타나고 데이터가 **[[!UICONTROL 대상 소싱 사양]](../../assets/quick-start/RTCDP_Collaboration_Audience_Sourcing_Spec_v1_3.pdf)**&#x200B;을 준수해야 한다는 점을 참고하십시오. 계속하기 전에 준수 여부를 확인하려면 **[!UICONTROL 온보딩 시작]**&#x200B;을 선택하세요.
...
>title="Google 클라우드 스토리지에서 대상자 추가"
>abstract="Google 클라우드 스토리지를 연결하려면 Adobe의 서비스 사용자가 대상자 데이터를 검색하여 처리할 수 있도록 권한을 부여하십시오. Experience League에 설명된 단계를 따라 Adobe에 Google 클라우드 스토리지에 대한 액세스 권한을 부여합니다."
...
표시된 매핑이 대상 파일의 필드를 반영하는지 확인합니다. 그렇지 않으면 계속하기 전에 [대상 소싱 사양](../../assets/quick-start/RTCDP_Collaboration_Audience_Sourcing_Spec_v1_3.pdf)을 준수하도록 파일을 중지하고 수정하십시오. 계속하려면 **[!UICONTROL 다음]**&#x200B;을 선택합니다.
...
* 버킷의 업데이트된 파일이 [대상 소싱 사양](../../assets/quick-start/RTCDP_Collaboration_Audience_Sourcing_Spec_v1_3.pdf)의 열 구조 및 필드 요구 사항을 준수하는지 확인하십시오.
