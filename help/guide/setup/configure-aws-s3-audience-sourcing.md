...
* **[대상 소싱 사양(v1.1)](../../assets/quick-start/RTCDP_Collaboration_Audience_Sourcing_Spec_v1.2.pdf)**&#x200B;을 준수하는 대상 파일을 포함하는 활성 **[!DNL Amazon S3]버킷**&#x200B;에 액세스할 수 있습니다.
...
**[!UICONTROL 메타데이터 가시성]**: 공동 작업자가 볼 수 있는 대상 정보(ID 수, 오버랩 비율 및 색인 등)를 정의합니다.
