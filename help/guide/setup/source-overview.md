...
| [Adobe Audience Manager](./configure-aam-audience-sourcing.md) | 기존 Audience Manager 세그먼트를 Collaboration 프로젝트로 가져옵니다. | 사용 가능 |
| [[!DNL Databricks Delta Share]](./configure-databricks-audience-sourcing.md) | [!DNL Databricks Delta Share]을(를) 연결하여 [!DNL Databricks] 환경에서 대규모 대상 데이터 세트를 가져옵니다. | 사용 가능 |
