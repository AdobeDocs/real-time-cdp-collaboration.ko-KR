...
| [!DNL Azure Blob Storage] | [!DNL Azure Blob Storage] 컨테이너를 [!DNL Microsoft Azure] 환경의 소스 자사 데이터 세트에 연결합니다. | *준비 중* |
| [!DNL Azure Data Lake Storage] | [!DNL Azure Data Lake Storage Gen 2] 계정을 연결하여 [!DNL Azure] 데이터 레이크에 저장된 대상 데이터를 가져옵니다. | *준비 중* |
