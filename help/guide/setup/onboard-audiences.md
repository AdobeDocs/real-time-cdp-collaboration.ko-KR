...
>title="소스 필드"
>abstract="Source 필드는 Experience Platform 구현의 id 네임스페이스 및 속성입니다. 이러한 매개 변수를 Collaboration에 정의된 타겟 필드에 매핑할 수 있습니다."
...
>title="변환 적용"
>abstract="*해시되지 않은* 필드를 소싱할 때 이 옵션을 사용하여 Collaboration에서 해시를 적용하고 일반 필드를 해시된 필드로 변환합니다."
...
>title="메타데이터 가시성"
>abstract="<p>다른 공동 작업자가 사용자와 연결하거나 프로젝트 보기 내에서 대상자의 메타데이터 중 어느 것을 볼 수 있는지 나타냅니다.</p> <p> **ID 개수**&#x200B;는 검색 탭에서 중복 보고서를 볼 때 공동 작업자가 대상에 대한 ID 개수를 볼 수 있는지 여부를 제어합니다. **대상자 중복 비율**&#x200B;은 공동 작업자가 자신의 대상자와 귀하의 대상자 간의 중복 비율을 확인할 수 있는지 여부를 제어합니다."
