...
>[!TIP]
>
>작업할 초기 계정 설정 후 동일한 작업 과정 을 사용하여 동일한 조직 내에서 추가 계정을 설정할 수 있습니다.

![Real-Time CDP Collaboration에 새 조직을 추가할 계정 선택](/help/assets/setup/manage-organization/add-new-account.png){zoomable="yes"}

조직을 설정하는 작업 과정에는 아래 두 페이지가 포함됩니다.

* [세부정보 설정](#set-up-details)
* [일치 키 설정](#set-up-match-keys)

>[!IMPORTANT]
>
>조직 수준에서 선택한 모든 *일치 키는* 광고주와 게시자 간의 공동 작업에서 프로젝트 수준으로](/help/guide/collaborate/manage-projects.md) 내려[갑니다. 그런 다음 프로젝트 수준에서 일치 키를 제거할 수 있지만 이 화면의 조직 수준에서 선택되지 않은 일치 키를 추가할 수 있는 기능은 *없음*&#x200B;입니다.
...
2. **[!UICONTROL 회사에 대한 설명]** 추가
3. **[!UICONTROL 회사 역할]** 선택 **[!UICONTROL Advertiser]**&#x200B;에서 **[!UICONTROL Publisher]** 중 하나를 선택할 수 있습니다. [통합 워크플로 문서](/help/guide/end-to-end-workflow.md)를 읽고 두 조직 역할 유형 간의 워크플로에서 유사점과 약간의 차이점을 확인하십시오.
...
>title="일치 키"
>abstract="일치 키는 서로 다른 데이터 소스의 대상 간에 구성원을 조정하는 데 사용되는 식별자입니다. 회사에서 사용할 수 있는 일치 키를 포함합니다."

>[!CONTEXTUALHELP]
>id="rtcdp_collaboration_organization_onboarding_peopleIDs"
>title="자사 사용자 ID"
>abstract="해시된 이메일 주소 또는 전화 번호와 같은 자사 사용자 ID는 개별 프로필에 직접 연결됩니다. 현재 지원되는 ID는 해시된 이메일 및 전화 번호입니다."
...
이메일 주소, 디바이스 ID 또는 고객 ID와 같은 일치 키를 사용하면 정확하고 개인 정보 보호를 준수하는 데이터 동기화를 통해 광고주와 게시자가 함께 작업할 수 있으므로 보다 정확한 대상자 타겟팅 및 측정이 가능합니다.

![Real-Time CDP Collaboration의 첫 번째 릴리스에 사용할 수 있는 식별자를 보여주는 슬라이드입니다.](/help/assets/setup/manage-organization/available-identifiers.png)
...
Real-Time CDP Collaboration에서 사용 가능한 일치 키는 다음 세 가지 유형이 될 수 있습니다.

* 자사 사용자 ID
* 자사 디바이스 ID
* 파트너 ID

Real-Time CDP Collaboration의 첫 번째 릴리스에 사용할 수 있는 일치 키는 다음과 같습니다.
...
![조직 편집 컨트롤이 강조 표시됩니다.](/help/assets/setup/manage-organization/edit-organization.png){zoomable="yes"}
