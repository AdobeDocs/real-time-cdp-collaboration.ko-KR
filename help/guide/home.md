---
title: 개요
description: Adobe Real-Time Customer Data Platform(CDP) Collaboration을 사용하여 서드파티 쿠키에 의존하지 않고도 가치가 높은 대상자를 발견, 활성화 및 측정하는 방법에 대해 알아봅니다.
...
액세스 권한이 있으면 계정을 설정하고 데이터 연결을 만들어 대상자 소싱을 시작할 준비가 되었습니다. 시작하려면 [전체 워크플로](/help/guide/overview/end-to-end-workflow.md)를 읽어 보세요.
